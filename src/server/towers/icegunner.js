...
function iceGunnerTower(arena, tower, delta) {
	tower.reload -= delta;
	...
	if (tower.reload < 0) {
		...
		if (tower.hasTarget) {
			...
			arena.bullets[bulletId] = new Bullet(bulletId, tower.x, tower.y, tower.dir + (Math.random() * 0.25) * randPolarity(), tower.bullets.bullet1, tower)
		}
	}
}

module.exports = iceGunnerTower;