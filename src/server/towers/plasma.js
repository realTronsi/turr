...
function plasmaTower(arena, tower, delta) {
	tower.reload -= delta;
	...
	if (tower.reload < 0) {
		...
		if (tower.hasTarget) {
			...
			arena.bullets[bulletId] = new Bullet(bulletId, tower.x + (Math.cos(tower.dir))*70, tower.y + (Math.sin(tower.dir))*70, tower.dir, TowerStats[tower.type].bullet, tower)
		}
	}
}

module.exports = plasmaTower